...
<div class="container" style="padding-top:24px; padding-bottom:40px;">
  <div style="background:#fff; border-radius:4px; padding:20px 24px; margin-bottom:24px; box-shadow:0 2px 8px rgba(0,0,0,.07); border-left:5px solid <?php echo $cat['color']; ?>;">
    <h1 style="font-size:22px; font-weight:800;"><?php echo htmlspecialchars($cat['name']); ?></h1>
